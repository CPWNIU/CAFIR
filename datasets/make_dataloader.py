...
from .partial_ilids import Paritial_ilids
from .p_dukemtmc import P_DukeMTMC
...
def make_dataloader(cfg):
    ...
    train_set = ImageDataset(dataset.train, train_transforms, crop_transform=crop_transforms,
                             eraser_transform=eraser_transforms)
