...
class GradCAM:
    ...
    def __call__(self, input_tensor,input_tensor2,input_tensor3, target_category=None):
        ...
        output = self.activations_and_grads(input_tensor,input_tensor2,input_tensor3)[0]
        print(output)
        if isinstance(target_category, int):
            target_category = ([target_category] * input_tensor.size(0)+
                               [target_category] * input_tensor2.size(0)+
                               [target_category] * input_tensor3.size(0))
